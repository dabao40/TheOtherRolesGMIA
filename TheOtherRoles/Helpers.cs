...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static bool hasFakeTasks(this PlayerControl player) {
            return (player == Jester.jester || player == Madmate.madmate || player == Jackal.jackal || player == Sidekick.sidekick || player == Arsonist.arsonist || player == Opportunist.opportunist || player == Vulture.vulture || Jackal.formerJackals.Any(x => x == player));
        }
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            else if (source.Data.Role.IsImpostor && (target.Data.Role.IsImpostor || target == Spy.spy || target == Madmate.madmate || target == Sidekick.sidekick && Sidekick.wasTeamRed || target == Jackal.jackal && Jackal.wasTeamRed)) return false; // Members of team Impostors see the names of Impostors/Spies
