...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static bool hasFakeTasks(this PlayerControl player) {
            return (player == Jester.jester || player == Jackal.jackal || player == Opportunist.opportunist || player == Sidekick.sidekick || player == Arsonist.arsonist || player == Vulture.vulture || Jackal.formerJackals.Any(x => x == player));
        }
        ...
        public static List<PlayerControl> getKillerTeamMembers(PlayerControl player) {
            ...
            foreach(PlayerControl p in CachedPlayer.AllPlayers) {
                ...
                else if (player == Sheriff.sheriff) team.Add(p);
            }
