...
namespace TheOtherRoles.Roles
{
    public class BomberA : RoleBase<BomberA>
    {
        ...
        {
            yield return new(getBomberButtonSprite(), "bomberPlantBombHint");
            yield return new(getReleaseButtonSprite(), "bomberReleaseBombHint");
        }
        ...
        public void playerIconsUpdate()
        {
            ...
            if (BomberB.isAlive() && !player.Data.IsDead && !MeetingHud.Instance)
            {
