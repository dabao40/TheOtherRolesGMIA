...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo niceWatcher = new RoleInfo("Nice Watcher", Watcher.color, "Pay close attention to the crew's votes", "Pay close attention to the crew's votes", RoleId.NiceWatcher);
        public static RoleInfo evilWatcher = new RoleInfo("Evil Watcher", Palette.ImpostorRed, "Pay close attention to the crew's votes", "Pay close attention to the crew's votes", RoleId.EvilWatcher);
        ...
        public static RoleInfo assassin = new RoleInfo("Assassin", Assassin.color, "Surprise and assassinate your foes", "Surprise and assassinate your foes", RoleId.Assassin);
        ...
        public static String GetRolesString(PlayerControl p, bool useColors, bool showModifier = true, bool suppressGhostInfo = false, bool includeHidden = false) {
            ...
            if (!suppressGhostInfo && p != null) {
                ...
                if (Helpers.shouldShowGhostInfo()) {
                    ...
                    if (p == FortuneTeller.target)
                        roleName = Helpers.cs(FortuneTeller.color, "(divined) ") + roleName;
