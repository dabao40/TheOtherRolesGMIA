...
namespace TheOtherRoles.Patches {
    ...
    class HudManagerUpdatePatch
    {
        ...
        public static void miniUpdate() {
            //  || Mini.mini == Assassin.assassin && Assassin.isInvisble
            if (Mini.mini == null || Camouflager.camouflageTimer > 0f || Mini.mini == Morphling.morphling && Morphling.morphTimer > 0f || Mini.mini == Ninja.ninja && Ninja.stealthed || Mini.mini == Sprinter.sprinter && Sprinter.sprinting || SurveillanceMinigamePatch.nightVisionIsActive) return;
