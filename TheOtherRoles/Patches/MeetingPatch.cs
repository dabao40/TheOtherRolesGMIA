    ...
    class MeetingHudPatch {
        ...
        static void guesserOnClick(int buttonTarget, MeetingHud __instance) {
            ...
            foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                ...
                if (new List<RoleId>() { RoleId.BountyHunter, RoleId.Madmate, RoleId.Camouflager, RoleId.Cleaner, RoleId.Eraser, RoleId.EvilGuesser, RoleId.Godfather, RoleId.Impostor, RoleId.Janitor, RoleId.Mafioso, RoleId.Morphling, RoleId.Ninja, RoleId.Trickster, RoleId.Undertaker, RoleId.Vampire, RoleId.Warlock, RoleId.Witch }.Contains(roleInfo.roleId) && guesserRole == RoleId.EvilGuesser && (CachedPlayer.LocalPlayer.PlayerControl.Data.Role.IsImpostor || CachedPlayer.LocalPlayer.PlayerControl == Madmate.madmate)) continue;
