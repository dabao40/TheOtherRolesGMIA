...
namespace TheOtherRoles.Patches {
    ...
    public static class VentUsePatch {
        public static bool Prefix(Vent __instance) {
            ...
            bool canMoveInVents = CachedPlayer.LocalPlayer.PlayerControl != Spy.spy || CachedPlayer.LocalPlayer.PlayerControl != Madmate.madmate; //&& !Trapper.playersOnMap.Contains(CachedPlayer.LocalPlayer.PlayerControl)
